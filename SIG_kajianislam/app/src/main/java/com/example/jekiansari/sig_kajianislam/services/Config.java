...
public class Config {
    //location server
    public static final String URL_GAMBAR = "http://192.168.1.3/SIGKajianIslam2/";
    public static final String URL_SERVER = "http://192.168.1.4/SIGKajianIslam2/MobileKajianIslam/";
