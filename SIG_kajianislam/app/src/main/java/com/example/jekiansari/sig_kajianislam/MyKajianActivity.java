...
//        implements OnMapReadyCallback
{
    ...
    String gUser;
    String warnaRAW = "";
    private ArrayList<LocationModel> mListMarker = new ArrayList<>();

    private RecyclerView rvMyKajian;
    private MyKajianAdapter adapter;
...
//        TextView TextUsername = (TextView)findViewById(R.id.username);
        rvMyKajian = findViewById(R.id.rvMyKajian);
        initRv();
...
//                Intent i = new Intent(MyKajianActivity.this,DetailPublicActivity.class);
