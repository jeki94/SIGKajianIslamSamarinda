...
//                editTextTanggalkajian.setText(date);
                ...
                editTextTanggalkajian.setText(sendParameter1);
    ...
    private void editKajian(
        ...
        Call<BaseResponse> call = apiService.editKajian(
                idKajian,
                username,
                namakajian,
                namapemateri,
...
//                Toast.makeText(this, ""+getPath(imgTempatUri), Toast.LENGTH_SHORT).show();
//                Glide.with(this)
//                        .load()
//                        .into(imageView);
                try {
